...
def=. '[Käyttöpaikka] long,[Asiakas] varchar(40),[Asiakastunnus] single,[Osoite] varchar(60),[Alkupvm] datetime,[Loppupvm] datetime,[photo] longbinary, constraint [pk_kaikki] primary key ([Käyttöpaikka],[Asiakas])'
...
def=. '[Käyttöpaikka] long,[Asiakas] varchar(60),[Asiakastunnus] single,[Osoite] varchar(50),[Postinro] long,[Postitmpk] varchar(30),[Hetu] varchar(20),[Laskuperuste] integer,[Alkupvm] datetime,[Loppupvm] datetime,[photo] longbinary'
...
smoutput 10&{.&.> sqtbchk (5{.cols__b) read__b u2a 'order by [Käyttöpaikka]'
