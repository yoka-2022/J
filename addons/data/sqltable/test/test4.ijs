...
smoutput sqtbchk writer__a t  NB. raise error if failed

smoutput 'first 10 rows'
smoutput 10&{. sqtbchk readr__a ''
...
smoutput 10&{. sqtbchk (5{.cols__b) readr__b u2a 'order by [Käyttöpaikka]'
